...
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS25} [get_ports config_rb]
set_property -dict {PACKAGE_PIN B21 IOSTANDARD LVCMOS25} [get_ports config_sout]
#set_property -dict {PACKAGE_PIN A19 IOSTANDARD LVCMOS25} [get_ports { config_ldtdac }]; #IO_L17N_T2_16 Sch=fmc_la_n[19] USED FOR CK2_B
#set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS25 } [get_ports { sample_clk_n }]; #IO_L12N_T1_MRCC_16 Sch=fmc_la18_cc_n USED FOR ENABLE_B
#set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS25 } [get_ports { sample_clk_p }]; #IO_L12P_T1_MRCC_16 Sch=fmc_la18_cc_p  USED FOR Cld_B
...
#set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS25 } [get_ports { untriggered_ro_en }]; #fmc_la_n[20] }]; #IO_L18N_T2_16 Sch=fmc_la_n[20] USED FOR Cld_T
#set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS25 } [get_ports { use_spi }]; #IO_L18P_T2_16 Sch=fmc_la_p[20]  USED FOR SIN_B
#set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS25 } [get_ports { hitbus }]; #fmc_la_n[21] }]; #IO_L14N_T2_SRCC_16 Sch=fmc_la_n[21] USED FOR CRB_T
#set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVCMOS25 } [get_ports { take_fast }]; #IO_L14P_T2_SRCC_16 Sch=fmc_la_p[21] USED FOR CRB_B
...
#set_property -dict { PACKAGE_PIN A21   IOSTANDARD LVDS_25 } [get_ports { trigger_test_n}]; #cdo_n }]; #IO_L21N_T3_DQS_16 Sch=fmc_la_n[23] USED FOR SOUT_T
#set_property -dict { PACKAGE_PIN B21   IOSTANDARD LVDS_25 } [get_ports { trigger_test_p}]; #cdo_p }]; #IO_L21P_T3_DQS_16 Sch=fmc_la_p[23] USED FOR SOUT_B
...
if {[lsearch -exact $defines_list CLOCK_SE_SE] != -1} {
...
#SPI left   HMM PIN B21 is already used?!!! SOUT! ALSO CRB_B --> E19
...
#if {[string first "config_singleended" $DEFINES] != -1} {
